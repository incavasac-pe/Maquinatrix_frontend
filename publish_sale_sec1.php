...
<div class="container">
          <div class="category-product">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button  onclick="setCategorySale(1,'Maquinaria y vehículos')"  class="nav-link tab-1" id="pills-publish1-tab" data-bs-toggle="pill" data-bs-target="#pills-publish1"
              ...
              <li class="nav-item" role="presentation">
                <button  onclick="setCategorySale(5,'Equipos y herramientas')" class="nav-link tab-5" id="pills-publish1-tab" data-bs-toggle="pill" data-bs-target="#pills-publish1"
              ...
              <li class="nav-item" role="presentation">
                <button  onclick="setCategorySale(4,'Productos y accesorios')"  class="nav-link tab-4" id="pills-publish1-tab" data-bs-toggle="pill" data-bs-target="#pills-publish1"
                  type="button" role="tab" aria-controls="pills-publish1" aria-selected="false"><img
              ...
              <li class="nav-item" role="presentation">
                <button  onclick="setCategorySale(2,'Repuestos')" class="nav-link tab-2" id="pills-publish1-tab" data-bs-toggle="pill" data-bs-target="#pills-publish1"
                  type="button" role="tab" aria-controls="pills-publish1" aria-selected="false"><img
              ...
              <li class="nav-item" role="presentation">
                <button  onclick="setCategorySale(3,'Neumáticos')" class="nav-link tab-3" id="pills-publish3-tab" data-bs-toggle="pill" data-bs-target="#pills-publish3"
 ...
 function setCategorySale(value,text, edit=false) {
    id_categoria = value;
    categoria = text;
